...
data.tar: dat/symbols
data.tar: dat/data
data.tar: dat/dungeon
data.tar: dat/options
data.tar: dat/oracles
data.tar: dat/quest.dat
data.tar: dat/pet_mark.xbm
data.tar: dat/pilemark.xbm
data.tar: dat/rip.xpm
data.tar: dat/rumors
data.tar: dat/sysconf
data.tar: dat/bogusmon
data.tar: dat/engrave
data.tar: dat/epitaph
	tar cf $@ $^
...
dat/bogusmon: dat/bogusmon.txt makedefs
	cd dat && ../makedefs -s

dat/engrave: dat/engrave.txt makedefs
	cd dat && ../makedefs -s

dat/epitaph: dat/epitaph.txt makedefs
	cd dat && ../makedefs -s
...
install: data.tar
	...
	install -o $(GAMEUID) -d $(GAMEDIR)/lib/nethackdir/save
...
clean:
	...
	$(RM) dat/{bogusmon,engrave,epitaph,pet_mark.xbm,pilemark.xbm}
	$(RM) data.tar
	$(RM) levels.tar *.lev
	$(RM) -r dep
